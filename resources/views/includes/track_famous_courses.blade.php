                            ...
                            <div class="famous_tracks">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    @foreach($famous_tracks as $track)
                                        ...
                                        <li><a  href="{{route('track',$track->name)}}" class="btn track-name">{{ $track->name }}</a></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm">
                                                    <div class="course_details">
                                                        <h3><a class="course_title" href="{{route('course',$course->slug)}}">{{ \Str::limit($course->title, 30) }}</a></h3>
