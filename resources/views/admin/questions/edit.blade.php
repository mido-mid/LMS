                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('questions.index') }}" class="btn btn-sm btn-primary">{{ __('list of questions') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('questions.update', $question) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('option_1') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="option_1" id="input-option_1" class="form-control form-control-alternative{{ $errors->has('option_1') ? ' is-invalid' : '' }}" placeholder="{{ __('option 1') }}" value="{{ old('option_1', $question->option_1) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('option_2') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="option_2" id="input-option_2" class="form-control form-control-alternative{{ $errors->has('option_2') ? ' is-invalid' : '' }}" placeholder="{{ __('option 2') }}" value="{{ old('option_2', $question->option_2) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('option_3') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="option_3" id="input-option_3" class="form-control form-control-alternative{{ $errors->has('answers') ? ' is-invalid' : '' }}" placeholder="{{ __('option 3') }}" value="{{ old('option_3', $question->option_3) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('option_4') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="option_4" id="input-option_4" class="form-control form-control-alternative{{ $errors->has('option_4') ? ' is-invalid' : '' }}" placeholder="{{ __('option 4') }}" value="{{ old('option_4', $question->option_4) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('right_answer') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="right_answer" id="input-right_answer" class="form-control form-control-alternative{{ $errors->has('right_answer') ? ' is-invalid' : '' }}" placeholder="{{ __('right_answer') }}" value="{{ old('right_answer', $question->right_answer) }}" required autofocus>
