                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ $track->name }} Track</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('tracks.courses.create', $track) }}" class="btn btn-sm btn-primary">{{ __('Add course') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3" style="margin-top:15px">
                            <div class="card">
                                @if($course->photo)
                                <img style="width:100%;height:170px;" src="{{ asset('images') }}/{{$course->photo->filename}}" class="card-img-top" alt="Course Photo">
                                @else
                                <img style="width:100%;height:170px;" src="{{ asset('images') }}/default.jpg" class="card-img-top" alt="Course Photo">
                                @endif
                                <div class="card-body">
